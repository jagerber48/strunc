...
def add_group_chars(string, group_char='_', direction=GroupingDirection.FORWARD, group_size=3):
    ...
    if direction is GroupingDirection.FORWARD:
        for char in string[::1]:
            ...
            group_counter += 1
            char_counter += 1
            if group_counter == group_size and char_counter < num_chars and char.isnumeric():
...
def add_group_chars_float(float_string, pre_group_char='_', post_group_char='_', group_size=3):
    ...
    pre_grouped_string = add_group_chars(pre_string, pre_group_char, GroupingDirection.BACKWARD,
                                         group_size)
    post_grouped_string = add_group_chars(post_string, post_group_char, GroupingDirection.FORWARD,
                                          group_size)
